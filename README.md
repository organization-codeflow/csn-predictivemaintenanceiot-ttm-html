...
```bash
git clone https://github.com/organization-codeflow/csn-predictivemaintenanceiot-ttm-html.git
cd csn-predictivemaintenanceiot-ttm-html
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-predictivemaintenanceiot-ttm-html
- Xem các metrics:
